...
<?php include('header.php');?>
    ...
    <div class="header_main_menu">
      <center><h1>Main Course</h1></center>
      <center><p>Here is Yummy and delicious Food.</p></center>
     ...
     if($res2 == TRUE){
      $count = mysqli_num_rows($res2);
       ...
       ";
        ...
        $_SESSION['favorite2'] = "<div class='done' >Added to favorite</div>";
        // header('location:http://localhost/php/starter_final.php');
         echo $_SESSION['favorite2'];
         unset($_SESSION['favorite2']);
       }
     }
